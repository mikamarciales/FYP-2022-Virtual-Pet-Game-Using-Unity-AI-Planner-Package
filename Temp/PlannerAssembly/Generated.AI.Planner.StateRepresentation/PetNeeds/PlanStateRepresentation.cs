...
namespace Generated.AI.Planner.StateRepresentation.PetNeeds
{
    ...
    public static class TraitArrayIndex<T> where T : struct, ITrait
    {
        ...
        static TraitArrayIndex()
        {
            ...
            if (typeIndex == TypeManager.GetTypeIndex<PetAgent>())
                Index = 0;
    ...
    public struct TraitBasedObject : ITraitBasedObject, IEquatable<TraitBasedObject>
    {
        ...
        static readonly int s_PetAgentTypeIndex = TypeManager.GetTypeIndex<PetAgent>();
        ...
        public bool MatchesTraitFilter(NativeArray<ComponentType> componentTypes)
        {
            for (int i = 0; i < componentTypes.Length; i++)
            {
                ...
                else if (t.TypeIndex == s_PetAgentTypeIndex)
                {
                    if (t.AccessModeType == ComponentType.AccessMode.Exclude ^ PetAgentIndex == Unset)
                        return false;
                }
        ...
        public bool Equals(TraitBasedObject other)
        {
                ...
                return PetAgentIndex == other.PetAgentIndex && LocationIndex == other.LocationIndex && NeedIndex == other.NeedIndex && Tree_FoodIndex == other.Tree_FoodIndex && Pet_TimeIndex == other.Pet_TimeIndex && PlanningAgentIndex == other.PlanningAgentIndex;
        }
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                    ...
                    var hashCode = PetAgentIndex.GetHashCode();
    ...
    public struct StateData : ITraitBasedStateData<TraitBasedObject, StateData>
    {
        ...
        public DynamicBuffer<PetAgent> PetAgentBuffer;
        ...
        public StateData(ExclusiveEntityTransaction transaction, Entity stateEntity)
        {
            ...
            PetAgentBuffer = transaction.GetBuffer<PetAgent>(stateEntity);
        ...
        public StateData(int jobIndex, EntityCommandBuffer.ParallelWriter entityCommandBuffer, Entity stateEntity)
        {
            ...
            PetAgentBuffer = entityCommandBuffer.AddBuffer<PetAgent>(jobIndex, stateEntity);
        ...
        public StateData Copy(int jobIndex, EntityCommandBuffer.ParallelWriter entityCommandBuffer)
        {
            ...
            var PetAgents = entityCommandBuffer.SetBuffer<PetAgent>(jobIndex, stateEntity);
            PetAgents.CopyFrom(PetAgentBuffer.AsNativeArray());
        ...
        public void AddObject(NativeArray<ComponentType> types, out TraitBasedObject traitBasedObject, TraitBasedObjectId objectId, FixedString64 name = default)
        {
            ...
            {
                var t = types[i];
                if (t.TypeIndex == s_PetAgentTypeIndex)
                {
                    PetAgentBuffer.Add(default);
                    traitBasedObject.PetAgentIndex = (byte) (PetAgentBuffer.Length - 1);
                }
                else if (t.TypeIndex == s_LocationTypeIndex)
                {
        ...
        {
            if (trait is PetAgent PetAgentTrait)
                SetTraitOnObject(PetAgentTrait, ref traitBasedObject);
        ...
        {
            if (trait is PetAgent PetAgentTrait)
                SetTraitOnObjectAtIndex(PetAgentTrait, traitBasedObjectIndex);
            else if (trait is Location LocationTrait)
        ...
        public bool RemoveObject(TraitBasedObject traitBasedObject)
        {
            ...
            RemoveTraitOnObject<PetAgent>(ref traitBasedObject);
        ...
        {
            RemoveTraitOnObjectAtIndex<PetAgent>(traitBasedObjectIndex);
        ...
        DynamicBuffer<T> GetBuffer<T>() where T : struct, ITrait
        {
            ...
            {
                case 0:
                    return PetAgentBuffer.Reinterpret<T>();
                case 1:
        ...
        public bool Equals(StateData rhsState)
        {
            ...
            if (TraitBasedObjects.Length != rhsState.TraitBasedObjects.Length
                || PetAgentBuffer.Length != rhsState.PetAgentBuffer.Length
        ...
        public override int GetHashCode()
        {
            ...
            bufferLength = PetAgentBuffer.Length;
        ...
        public override string ToString()
        {
            ...
            for (var traitBasedObjectIndex = 0; traitBasedObjectIndex < numObjects; traitBasedObjectIndex++)
            {
                ...
                if (traitIndex != TraitBasedObject.Unset)
                    sb.AppendLine(PetAgentBuffer[traitIndex].ToString());
    ...
    public struct StateDataContext : ITraitBasedStateDataContext<TraitBasedObject, StateEntityKey, StateData>
    {
        ...
        [ReadOnly,NativeDisableContainerSafetyRestriction] public BufferFromEntity<PetAgent> PetAgentData;
        ...
        public StateDataContext(SystemBase system, EntityArchetype stateArchetype)
        {
            ...
            PetAgentData = system.GetBufferFromEntity<PetAgent>(true);
        ...
        public StateData GetStateData(StateEntityKey stateKey)
        {
            ...
            return new StateData
            {
                ...
                PetAgentBuffer = PetAgentData[stateEntity],
