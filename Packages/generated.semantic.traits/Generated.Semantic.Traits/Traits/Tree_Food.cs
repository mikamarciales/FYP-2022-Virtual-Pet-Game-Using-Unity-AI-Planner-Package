...
namespace Generated.Semantic.Traits
{
    ...
    [AddComponentMenu("Semantic/Traits/Tree_Food (Trait)")]
    [RequireComponent(typeof(SemanticObject))]
    public partial class Tree_Food : MonoBehaviour, ITrait
    {
        ...
        public void Convert(Entity entity, EntityManager destinationManager, GameObjectConversionSystem _)
        {
            ...
            if (!destinationManager.HasComponent(entity, typeof(Tree_FoodData)))
            {
                destinationManager.AddComponent<Tree_FoodData>(entity);
            }
        }
        ...
        void OnDestroy()
        {
            ...
            {
                m_EntityManager.RemoveComponent<Tree_FoodData>(m_Entity);
        ...
        void OnDrawGizmos()
        {
            TraitGizmos.DrawGizmoForTrait(nameof(Tree_FoodData), gameObject,null);
        }
#endif
    }
}
