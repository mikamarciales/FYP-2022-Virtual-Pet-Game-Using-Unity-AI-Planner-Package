...
namespace Generated.Semantic.Traits
{
    ...
    [AddComponentMenu("Semantic/Traits/Home_Energy (Trait)")]
    [RequireComponent(typeof(SemanticObject))]
    public partial class Home_Energy : MonoBehaviour, ITrait
    {
        ...
        public void Convert(Entity entity, EntityManager destinationManager, GameObjectConversionSystem _)
        {
            ...
            if (!destinationManager.HasComponent(entity, typeof(Home_EnergyData)))
            {
                destinationManager.AddComponent<Home_EnergyData>(entity);
            }
        }
        ...
        void OnDestroy()
        {
            ...
            {
                m_EntityManager.RemoveComponent<Home_EnergyData>(m_Entity);
        ...
        void OnDrawGizmos()
        {
            TraitGizmos.DrawGizmoForTrait(nameof(Home_EnergyData), gameObject,null);
        }
#endif
    }
}
