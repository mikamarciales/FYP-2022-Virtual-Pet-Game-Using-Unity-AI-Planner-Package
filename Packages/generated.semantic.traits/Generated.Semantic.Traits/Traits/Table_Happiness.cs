...
namespace Generated.Semantic.Traits
{
    ...
    [AddComponentMenu("Semantic/Traits/Table_Happiness (Trait)")]
    [RequireComponent(typeof(SemanticObject))]
    public partial class Table_Happiness : MonoBehaviour, ITrait
    {
        ...
        public void Convert(Entity entity, EntityManager destinationManager, GameObjectConversionSystem _)
        {
            ...
            if (!destinationManager.HasComponent(entity, typeof(Table_HappinessData)))
            {
                destinationManager.AddComponent<Table_HappinessData>(entity);
            }
        }
        ...
        void OnDestroy()
        {
            ...
            {
                m_EntityManager.RemoveComponent<Table_HappinessData>(m_Entity);
        ...
        void OnDrawGizmos()
        {
            TraitGizmos.DrawGizmoForTrait(nameof(Table_HappinessData), gameObject,null);
        }
#endif
    }
}
