    ...
    struct Play : IJobParallelForDefer
    {
        ...
        void GenerateArgumentPermutations(StateData stateData, NativeList<ActionKey> argumentPermutations)
        {
            ...
            for (int i3 = 0; i3 < happinessObjectIndices.Length; i3++)
            {
                ...
                if (!(NeedBuffer[happinessObject.NeedIndex].HappinessLevel <= 75))
                    continue;
        ...
        StateTransitionInfoPair<StateEntityKey, ActionKey, StateTransitionInfo> ApplyEffects(ActionKey action, StateEntityKey originalStateEntityKey)
        {
            ...
            var newPet_TimeBuffer = newState.Pet_TimeBuffer;
            {
                    ...
                    @Need.HappinessLevel += newNeedBuffer[originalhappinessObject.NeedIndex].HappinessTick;
            ...
            {
                    new global::AI.Planner.Custom.PetAgentPlan.CustomPlayedEffects().ApplyCustomActionEffectsToState(originalState, action, newState);
            }
